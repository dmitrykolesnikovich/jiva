 ...
 */
public class JivaTreeWalkErrorListener extends BaseErrorListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(JivaTreeWalkErrorListener.class);
